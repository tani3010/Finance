...
class BaseFDSABR:
    ...
    def density(self, strikes, discount=1.0, gap=1e-04):
        f = interp1d(self.Fm_shifted, self.probability_density, kind='linear')
        return f(strikes)
...
if __name__  ==  '__main__':
    ...
    my_plot('PDF of advanced SABR model', 'strike', 'density',
           ...
           None, None, './advancedSABR_pdf.pdf')
